...
public class ExpositionController {
    ...
    public ExpositionController(ExpositionRepository dao, GalerieRepository galeriedao) {
        this.dao = dao;
    ...
    public String afficheToutesLesExposition(Model model) {
     ...
     * @param model pour transmettre des informations à la vue
    ...
    public String montreLeFormulairePourAjout(@ModelAttribute("exposition") Exposition expo, Model model) {
        ...
        model.addAttribute("expo", galeriedao.findAll());
